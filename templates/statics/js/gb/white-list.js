...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ajaxLoadParse = __webpack_require__(5);
	...
	function whiteList() {
	    ...
	    var addHtml = function addHtml() {
	        var html = "<tr class=\"newWhite\"><td></td>\n                    <td><input placeholder=\"\u8BF7\u8F93\u5165\u8F66\u724C\u53F7\" type=\"text\" class=\"plate-num form-control\" value=\"\"></td>\n                    <td><input type=\"button\" class=\"btn btn-info\" value=\"\u786E\u5B9A\"></td>\n                </tr>";
	        return html;
	    };

	    //添加白名单
	    $("#btn-add").on("click", function () {
	        if ($(".newWhite").length < 1) {
	            $(".table-white tbody").append(addHtml);
	            buildinit();
	        } else {
	            alertify.error("请添加车牌号后继续添加");
	        }
	    });
	    //添加车牌号
	    function buildinit() {
	        //车牌号
	        Forms.plateNumCity(".plate-num", 1);
	        //确定
	        $(".btn-info").on("click", function () {
	            if ($(".plate-num").val() != "") {
	                if (!Forms.validation.plate($(".plate-num"))) return false;
	                (0, _ajaxLoadParse.ajaxLoad)({
	                    url: ajaxURL.addPlateUrl,
	                    data: { "plate_number": $(".plate-num").val() },
	                    dataType: "json"
	                }, function (res) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _yisaSelect = __webpack_require__(3);
