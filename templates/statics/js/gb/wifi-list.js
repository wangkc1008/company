...
/***/ (function(module, exports, __webpack_require__) {
	...
	function wifiList() {
	    ...
	    $('#addLocation').on('click', function () {
	        temp = {};
	        // $("#associatePoint").html("");
	        // $("#associatePoint").multiselect("refresh");
	    ...
	    /*$('#searchForm').on('submit', function () {
	     let name = $(this).find('input[name=location_name]').val();
	     let id = $(this).find("input[name='region_id']").val();
	       if (name == '' && id == "") {
	    ...
	    $('#save').on('click', function () {
	        if ($("#associatePoint").val()) {
	            form.find('input[name=associate-point]').val($("#associatePoint").val());
	        }

	        var url = '';
	        /*let type = form.find("input[name='location_type']:checked").val();
	        let join = form.find("input[name='join_type']:checked").val();
	        let source = form.find("input[name=source_id]:checked").val();*/
	        ...
	        var point = form.find('input[name=associate-point]').val();
	    ...
	    $('#editModal').on('shown.bs.modal', function () {
	        ...
	        if (temp.id) {
	            ...
	            $("input[name=location_id]").val(temp.id);
	            ...
	            $('input[name=associate-point]').val(temp.point);
	            ...
	            $('input[name=lng]').val('');
	            $('input[name=lat]').val('');
	            $('input[name=associate-point]').val('');
	        }
	        ...
	        $(".multiselect-container input[type='checkbox']").on("click", function () {
	            ...
	            if (_this.prop("checked")) {
	                ...
	                if (_id && _id != "undefined") {
	                    ...
	                    if (_marker && _marker != "undefined") mapCtrl.iconRecover(_marker);
	                }
	                //mapCtrl.iconPicked(marker);
	            }
	        });
