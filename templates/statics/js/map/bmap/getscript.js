...
(function() {
    ...
    x.D.tj = function(a, b) {
        ...
        if (!d)var e = c.DB[b], d = a.currentStyle || (x.da.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
    ...
    x.D.ha = function(a) {
        a = x.D.$(a);
        if (a === p)return a;
        var b = x.D.FD(a), c = x.da, d = x.D.tj;
    ...
    x.SK = function() {
        function a(a) {
            document.addEventListener && (this.element = a, this.VK = this.yk ? 'touchstart' : 'mousedown', this.nD = this.yk ? 'touchmove' : 'mousemove', this.mD = this.yk ?
                'touchend' :
                'mouseup', this.qh = q, this.eu = this.du = 0, this.element.addEventListener(this.VK, this, q), ja.M(this.element, 'mousedown', s()), this.handleEvent(p))
        }
    ...
    var ra = window.BMap_loadScriptTime, sa = (new Date).getTime(), ta = p, ua = o, va = 5042, wa = 5002, xa = 5003, ya = 'load_mapclick', za = 5038, Ba = 5041, Ca = 5047,
        Da = 5036, Fa = 5039, Ga = 5037, Ha = 5040, Ia = 5011, Ja = 7E3;
    var Ka = 0;
    ...
    function La(a, b) {
        if (a = x.$(a)) {
            ...
            c.K.ue && (this.dY(c.K.ue.controls), this.YL(c.K.ue.geotableId));
    ...
    x.extend(La.prototype, {
        va: function() {
            ...
            var e = this.pa().Ac(this.fa()), f = this.xe, g = o;
            ...
            var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || p, b = this.wb({x: a[3], y: this.height - a[2]}, c), a = this.wb({x: this.width - a[1], y: a[0]}, c);
            return new eb(b, a)
        }, Kx: function() {
            return !!this.loaded
        }, OR: function(a, b) {
            ...
            e = this.OR(d, b);
            b.margins &&
            (d = b.margins, f = (d[1] - d[3]) / 2, d = (d[0] - d[2]) / 2, g = this.pa().Ac(e), b.offset && (f = b.offset.width, d = b.offset.height), c.lng += g * f, c.lat += g *
                d);
            ...
            var a = this.Ib.Vo(), b = this.Ib.pm(), c = this.K;
            c.gc = c.JO || a;
            c.$b = c.IO || b;
            c.gc < a && (c.gc = a);
            c.$b > b && (c.$b = b)
            ...
            a ? this.js && this.js.Af === a || (this.yh(this.js), this.js = new mb({geotableId: a}), this.Xg(this.js)) : this.yh(this.js)
        }, Vb: function() {
            ...
            return {name: this.Zg, code: this.Yr}
        }, qm: function() {
            this.P.Yn();
            return this.P
            ...
            for (var b = {featureType: 't', elementType: 'e', visibility: 'v', color: 'c', lightness: 'l', saturation: 's', weight: 'w', zoom: 'z', hue: 'h'}, c = {
                all: 'all',
                geometry: 'g',
                'geometry.fill': 'g.f',
                'geometry.stroke': 'g.s',
    ...
    function Ra(a, b) {
        if (a) {
            ...
            nb ?
                pb.push({src: 'product=jsapi&sub_product=jsapi&v=' + z.version + '&sub_product_v=' + z.version + '&t=' + d + '&code=' + a + '&da_src=' + a + c}) :
                e({src: 'product=jsapi&sub_product=jsapi&v=' + z.version + '&sub_product_v=' + z.version + '&t=' + d + '&code=' + a + '&da_src=' + a + c});
    ...
    z.SL = {
        ...
        main_domain_nocdn: {baidu: 'gsp0.baidu.com/9_Q4sjOpB1gCo2Kml5_Y_D3', other: host},
        main_domain_cdn: {
    ...
    z.YX = {
        ...
        TILE_ONLINE_URLS: [bmapTile, bmapTile, bmapTile, bmapTile, bmapTile],
        ...
        main_domain_nocdn: {baidu: host},
        main_domain_cdn: {baidu: [host, 'api1.map.bdimg.com', 'api2.map.bdimg.com'], webmap: ['webmap0.map.bdimg.com']},
        map_click: 'mapclick.map.baidu.com',
        vector_traffic: 'or.map.bdimg.com'
    };
    z.V_ = {'0': {proto: 'http://', domain: z.YX}, 1: {proto: 'https://', domain: z.SL}, 2: {proto: 'https://', domain: z.SL}};
    ...
    function ub(a) {
        var b = ab();
        b >= a.Wz ?
            (Ya(a.k.va) && a.k.va(a.k.jc(1)), Ya(a.k.finish) && a.k.finish(), 0 < a.$f.length && (b = a.$f[0], b.$f = [].concat(a.$f.slice(1)), b.start())) :
            (a.uy = a.k.jc((b - a.Ku) / a.k.duration), Ya(a.k.va) && a.k.va(a.uy), a.EF || (a.Qr = setTimeout(function() {
                ub(a)
            }, 1E3 / a.k.Gc)))
    }
    ...
    x.da.nf ?
        (x.extend(E, {CK: 'url(' + E.qa + 'ruler.cur),crosshair', Xb: '-moz-grab', Fd: '-moz-grabbing'}), x.platform.lM && (E.fontFamily = 'arial,simsun,sans-serif')) :
        x.da.dC || x.da.hF ?
            x.extend(E, {CK: 'url(' + E.qa + 'ruler.cur) 2 6,crosshair', Xb: 'url(' + E.qa + 'openhand.cur) 8 8,default', Fd: 'url(' + E.qa + 'closedhand.cur) 8 8,move'}) :
            x.extend(E, {CK: 'url(' + E.qa + 'ruler.cur),crosshair', Xb: 'url(' + E.qa + 'openhand.cur),default', Fd: 'url(' + E.qa + 'closedhand.cur),move'});
    function vb(a, b) {
        var c = a.style;
        c.left = b[0] + 'px';
        c.top = b[1] + 'px'
    ...
    function Ib(a) {
        ...
        do c = Hb.indexOf(a.charAt(i++)), d = Hb.indexOf(a.charAt(i++)), f = Hb.indexOf(a.charAt(i++)), g = Hb.indexOf(a.charAt(i++)), c = c << 2 | d >> 4, d = (d & 15) << 4 |
            f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(c), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e)); while (i < a.length);
        return b
    }
    ...
    function F() {
        return !(!x.platform.nE && !x.platform.oY && !x.platform.Fm)
    }
    ...
    void function(a, b, c) {
        void function(a, b, c) {
            ...
            function w(a) {
                this.name = a;
                this.Hs = {protocolParameter: {postUrl: p, protocolParameter: p}};
                this.TJ = [];
                this.alog = L
            }
            ...
            if (!C || !C.Fo) {
                var B = b.all && a.attachEvent, D = C && C.wE || +new Date, A = a.o3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), G = 0, J = {},
                    L = function(a) {
                        ...
                        if ('define' == a || 'require' == a) {
                            ...
                            c = !c ? '#' + G++ : c;
                            d = ea[c] = ea[c] || {};
                            d.Fo || (d.name = c, d.sZ = e, d.uK = f, 'define' == a && (d.ZV = o), g(d))
                ...
                w.prototype.send = function(a, b) {
                    var c = v({ts: i().toString(36), t: a, sid: A}, this.Hs);
                ...
                w.prototype.set = function(a, b) {
                    if ('string' == typeof a) 'protocolParameter' == a && (b = v({postUrl: p, protocolParameter: p}, b)), this.Hs[a] = b; else if ('object' ==
                        typeof a)for (var c in a)this.set(c, a[c])
                };
                ...
                L('init');
                var fa = w.prototype;
                S(fa, {start: fa.start, create: fa.create, send: fa.send, set: fa.set, get: fa.get, on: fa.M, un: fa.bd, fire: fa.Is});
                var Ea = y();
                ...
                a.onerror = function(a, b, d, e) {
                    ...
                    g && c.alog('exception.send', 'exception', {yt: a, vE: b, ut: d, $r: e});
                    return q
                };
        ...
        void function(a, b, c) {
            ...
            var k = Math.random, i = i + '/tb/pms/img/st.gif', l = {zh: '0.1'}, m = {zh: '0.1'}, n = {zh: '0.1'}, t = {zh: '0'};
            if (l && l.zh && k() < l.zh) {
            ...
            if (t && t.zh && k() < t.zh) {
                var B = ['Moz', 'O', 'ms', 'Webkit'], D = ['-webkit-', '-moz-', '-o-', '-ms-'], A = function() {
                    ...
                    return !(!Array.prototype || !Array.prototype.every || !Array.prototype.filter || !Array.prototype.forEach || !Array.prototype.indexOf ||
                    !Array.prototype.lastIndexOf || !Array.prototype.map || !Array.prototype.some || !Array.prototype.reduce || !Array.prototype.reduceRight || !Array.isArray)
                }, se = function() {
                    ...
                    var b = !!a.u0, c = a.XMLHttpRequest && 'withCredentials' in new XMLHttpRequest;
                    return !!a.x0 && b && c
                }, of = function() {
    ...
    x.object.extend(I, {
        Fj: {nG: -1, GP: 0, Xp: 1}, oL: function() {
            var a = 'canvablepath', b = z.HU ? 'newvectordrawlib' : 'vectordrawlib';
        ...
        }, O3: {}, gG: {XP: z.ma + 'getmodules?v=2.0&t=20140707', yU: 5E3}, CC: q, Pd: {rl: {}, Cn: [], Qv: []}, load: function(a, b, c) {
            var d = this.ib(a);
            if (d.Bd == this.Fj.Xp) c && b(); else {
                if (d.Bd == this.Fj.nG) {
                    this.jK(a);
                    this.wN(a);
                    var e = this;
            ...
            for (var a = this.Pd.Qv, b = 0, c = a.length; b < c; b++)this.yZ(a[b].QM, a[b].JE);
            this.Pd.Qv.length = 0
        }
    });
    function Q(a, b) {
    ...
    function hb(a, b) {
        a && (this.Lb = a, this.ba = 'spot' + hb.ba++, b = b || {}, this.Ug = b.text || '', this.wv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.sJ = b.userData ||
            p, this.Qh = b.minZoom || p, this.Ff = b.maxZoom || p)
    }
    ...
    function ib(a) {
        Sb.call(this);
        a = a || {};
        this.k = {Ag: q, AF: a.showZoomInfo || o, anchor: a.anchor, za: a.offset, type: a.type, uW: a.enableGeolocation || q};
    ...
    function Wb(a) {
        Sb.call(this);
        a = a || {};
        this.k = {anchor: a.anchor || Vb, za: a.offset || new N(10, 30), i_: a.showAddressBar !== q, Y1: a.enableAutoLocation || q, EM: a.locationIcon || p};
        var b = this;
        this.vz = 1200;
        b.X_ = [];
        this.le = [];
    ...
    function kb(a) {
        Sb.call(this);
        a = a || {};
        this.k = {Ag: q, size: a.size || new N(150, 150), padding: 5, Wa: a.isOpen === o ? o : q, l0: 4, za: a.offset, anchor: a.anchor};
    ...
    function Yb(a) {
        ...
        this.k = {Ag: q, za: a.offset || this.defaultOffset, anchor: a.anchor || this.defaultAnchor, expand: !!a.expand};
    ...
    function jb(a) {
        ...
        this.qc(a.anchor);
        this.Zh = {metric: {name: 'metric', lK: 1, XL: 1E3, CO: '\u7c73', DO: '\u516c\u91cc'}, us: {name: 'us', lK: 3.2808, XL: 5280, CO: '\u82f1\u5c3a', DO: '\u82f1\u91cc'}};
    ...
    function lb(a) {
        ...
        this.defaultOffset = new N(10, 10);
        this.k = {Ag: q, oh: [Ma, Za, Sa, Pa], YV: ['B_DIMENSIONAL_MAP', 'B_SATELLITE_MAP', 'B_NORMAL_MAP'], type: a.type || Zb, za: a.offset || this.defaultOffset, yW: o};
        this.qc(a.anchor);
    ...
    x.object.extend(cc.prototype, {
        ra: function(a, b) {
            ...
            if (this.Ce[a]) {
                for (var b = 0, c = this.ya.length; b < c; b++)this.ya[b] && ('divider' == this.ya[b].Mb && this.ya[b].Nj == a) && (this.ya.splice(b, 1), c--), this.ya[b] &&
                ('divider' == this.ya[b].Mb && this.ya[b].Nj > a) && this.ya[b].Nj--;
                this.Ce.splice(a, 1)
            }
        }, Id: u('B'), show: function() {
            this.Ph != o && (this.Ph = o)
    ...
    x.object.extend(eb.prototype, {
        yj: function() {
            ...
            if (!(a instanceof eb) || Math.max(a.Le, a.Ge) < Math.min(this.Le, this.Ge) || Math.min(a.Le, a.Ge) > Math.max(this.Le, this.Ge) ||
                Math.max(a.Ke, a.Fe) < Math.min(this.Ke, this.Fe) || Math.min(a.Ke, a.Fe) > Math.max(this.Ke, this.Fe))return p;
    ...
    x.extend(gb.prototype, {
        Im: function(a, b) {
            ...
            I.load('coordtrans', function() {
                var a = hc.PD(c.fj || 'bj', d), a = new Q(a.x, a.y);
                b && b(a)
            }, o)
        }, pointToLngLatFor3D: function(a, b) {
            var c = this, d = new H(a.x, a.y);
            I.load('coordtrans', function() {
                var a = hc.OD(c.fj || 'bj', d), a = new H(a.lng, a.lat), a = R.Fb(a);
                b && b(a)
            }, o)
        }, EQ: function(a, b) {
    ...
    x.extend(fb.prototype, {
        ...
        }, Vt: ba('zIndex'), nj: function() {
            this.z.nj = o
        }, hW: function() {
            this.z.nj = q
        }, so: ba('ig'), yp: function() {
            this.ig = p
        }
    });
    function kc() {
    ...
    function oc(a) {
        fb.call(this);
        this.V = this.map = p;
        this.z = {width: 0, height: 0, za: new N(0, 0), opacity: 1, background: 'transparent', Qx: 1, vM: '#000', zY: 'solid', point: p};
        this.ON(a);
    ...
    x.extend(oc.prototype, {
        Hj: function() {
            ...
            'none' != a.borderColor && c.push('border:' + a.Qx + 'px ' + a.zY + ' ' + a.vM + ';');
    ...
    function pc(a, b, c) {
        a && b && (this.imageUrl = a, this.size = b, a = new N(Math.floor(b.width / 2), Math.floor(b.height / 2)), c = c || {}, a = c.anchor || a, b = c.imageOffset ||
            new N(0, 0), this.imageSize = c.imageSize, this.anchor = a, this.imageOffset = b, this.infoWindowAnchor = c.infoWindowAnchor ||
            this.anchor, this.printImageUrl = c.printImageUrl || '')
    }
    ...
    function rc(a, b, c, d) {
        a && (this.Bv = {}, this.$K = d ? !!d : q, this.Uc = [], this.w_ = a instanceof qc ? a : p, this.FI = b === j ? o : !!(b.indexOf('%') + 1), this.Zj = isNaN(parseFloat(b)) ?
            1 :
            this.FI ?
                parseFloat(b) / 100 :
                parseFloat(b), this.GI = !!(c.indexOf('%') + 1), this.repeat = c != j ? this.GI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    function sc(a, b) {
        x.lang.Ca.call(this);
        this.content = a;
    ...
    La.prototype.Nb = function(a, b) {
        if (a instanceof sc && b instanceof H) {
            var c = this.R;
            c.Km ? c.Km.ta(b) : (c.Km = new T(b, {icon: new pc(E.qa + 'blank.gif', {width: 1, height: 1}), offset: new N(0, 0), clickable: q}), c.Km.CR = 1);
            this.Ja(c.Km);
            c.Km.Nb(a)
        }
    };
    ...
    function tc(a, b) {
        ...
        this.z = {
            width: 0,
            za: b.offset || new N(0, 0),
            Qp: {backgroundColor: '#fff', border: '1px solid #f00', padding: '1px', whiteSpace: 'nowrap', font: '12px ' + E.fontFamily, zIndex: '80', MozUserSelect: 'none'},
    ...
    function yc(a, b) {
        var c = this;
        xc() && (a === j && aa(Error('\u6ca1\u6709\u4f20\u5165points\u6570\u636e')), '[object Array]' !== Object.prototype.toString.call(a) &&
        aa(Error('points\u6570\u636e\u4e0d\u662f\u6570\u7ec4')), b = b || {}, fb.apply(c, arguments), c.ea = {ia: a}, c.z = {
            shape: b.shape || vc,
            size: b.size || wc,
    ...
    var zc = new pc(E.qa + 'marker_red_sprite.png', new N(19, 25), {anchor: new N(10, 25), infoWindowAnchor: new N(10, 0)}),
        Ac = new pc(E.qa + 'marker_red_sprite.png', new N(20, 11), {anchor: new N(6, 11), imageOffset: new N(-19, -13)});
    ...
    x.extend(Bc.prototype, {
        he: function(a, b) {
            ...
            this.po[a] && (this.po[a] = new H(b.lng, b.lat), this.ia[a] = new H(b.lng, b.lat), 0 == a && !this.ia[0].nb(this.ia[this.ia.length - 1]) &&
            (this.ia[this.ia.length - 1] = new H(b.lng, b.lat)), this.Eh())
        }, qe: function() {
            var a = this.po;
    ...
    x.extend(Dc.prototype, {
        initialize: function(a) {
            ...
            for (var c = [], d = b / 6378800, e = Math.PI / 180 * a.lat, f = Math.PI / 180 * a.lng, g = 0; 360 > g; g += 9) {
                var i = Math.PI / 180 * g, k = Math.asin(Math.sin(e) * Math.cos(d) + Math.cos(e) * Math.sin(d) * Math.cos(i)), i = new H(
                    ((f - Math.atan2(Math.sin(i) * Math.sin(d) * Math.cos(e), Math.cos(d) - Math.sin(e) * Math.sin(k)) + Math.PI) % (2 * Math.PI) - Math.PI) * (180 / Math.PI),
                    k * (180 / Math.PI));
                c.push(i)
            }
            d = c[0];
    ...
    x.extend(Fc.prototype, {
        ra: function() {
            ...
            var d = this.map, e = d.pa(), f = d.Oa, g = d.mc, i = e.Ac(f), k = this.mL(), l = k[0], m = k[1], n = k[2], t = k[3], v = k[4], c = 'undefined' != typeof c ? c : 0,
                e = e.k.Pb, k = d.ba.replace(/^TANGRAM_/, '');
            ...
            l = 0;
            for (d = this.Qc.length; l < d; l++)B = this.Qc[l][0], i = this.Qc[l][1], t = B * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + '_' + b + '_' + B + '_' +
                i + '_' + f, m = this.Pm[y], n = p, m ?
                (n = m.style, n.left = t + 'px', n.top = v + 'px', m.Ze || this.kn.push([B, i, m])) :
                (0 < this.Ne.length ?
                    (m = this.Ne.shift(), m.getContext('2d').clearRect(-c / 2, -c / 2, w, w), n = m.style) :
                    (m = document.createElement('canvas'), n = m.style, n.position = 'absolute', n.width = e + c + 'px', n.height = e + c + 'px', this.Mx() &&
                    (n.WebkitTransform = 'scale(1.001)'), m.setAttribute('width', w), m.setAttribute('height', w), a.appendChild(m)), m.id = y, n.left = t + 'px', n.top = v +
                    'px', -1 < y.indexOf('bg') && (t = '#F3F1EC', this.map.K.xo && (t = this.map.K.xo), n.background = t ? t : ''), this.kn.push(
                    [B, i, m])), m.style.visibility = '';
            l = 0;
            ...
            var a = this.map, b = a.pa(), c = b.aE(a.Oa), d = a.mc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Pb,
            ...
            var e = this;
            e.B1 = b;
            var f = this.map.pa(), g = e.WD(a, c), i = f.k.Pb, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]], k = this.wg[g];
            ...
            k && k.Hb ?
                (vb(k.Hb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : 'normal', d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ?
                    this.yf() :
                    Jc(k, function() {
                        e.yf()
                    })) :
                (k = this.ej[g]) && k.Hb ?
                    (c.Qb.insertBefore(k.Hb, c.Qb.lastChild), this.wg[g] = k, vb(k.Hb, b), d &&
                    (d = new Q(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : 'normal', d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ?
                        this.yf() :
                        Jc(k, function() {
                            e.yf()
                        })) :
                    (k = i * Math.pow(2, f.pm() - a[2]), new H(a[0] * k, a[1] * k), d = new Q(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : 'normal', d = c.getTilesUrl(d,
                ...
                if (a.rh == 0) {
                    ...
                    if (ua) {
                        if (ra && sa && ta) {
                            var b = ab(), c = a.map.Ab();
                            setTimeout(function() {
                                Ra(5030, {load_script_time: sa - ra, load_tiles_time: b - ta, map_width: c.width, map_height: c.height, map_size: c.width * c.height})
                            }, 1E4);
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.$H && !(i.lp && !this.map.Vb() || i.jM && this.map.Vb())) {
                    ...
                    var t = e.Ac(m), k = e.aE(m), l = Math.ceil(f.lng / k), v = Math.ceil(f.lat / k), w = e.k.Pb, k = [l, v, (f.lng - l * k) / k * w, (f.lat - v * k) / k * w],
                        n = k[0] - Math.ceil((d.width / 2 - k[2]) / w), l = k[1] - Math.ceil((d.height / 2 - k[3]) / w), v = k[0] + Math.ceil((d.width / 2 + k[2]) / w), y = 0;
                    e === Pa && 15 == d.fa() && (y = 1);
            ...
            if (c instanceof cb) a && !c.Em && (c.ra(this.map, this.ld), c.Em = o); else if (c.Yf && this.map.Xg(c.Yf), c.lp) {
            ...
            if (a instanceof cb) b && a.Em && (a.remove(), a.Em = q); else {
                ...
                if (a.lp)for (var b = 0, c = this.Dg.length; b < c; b++)a == this.Dg[b] && this.Dg.splice(b, 1); else {
                    b = 0;
            ...
            var b = this.map.pa();
            if (!this.map.Vb() && (a ? this.map.K.t_ = a : a = this.map.K.t_, a))for (var c = p, c = '2' == z.Oy ?
                ...
                [
                    ...
                    z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + '/'], d = 0, e; e = this.Jm[d]; d++)if (e.g_ == o) {
                b.k.$b = 18;
                e.getTilesUrl = function(b, d) {
                    var e = b.x, e = this.map.cb.yw(e, d).$r, k = b.y, l = 1;
                    this.map.Fx() && (l = 2);
        ...
        this.Hb.onload = function() {
            ...
            if (g.Mm) {
                ...
                if (g.Hb && !xb(g.Hb) && e.Qb) {
                    ...
                    if (x.da.la <= 6 && x.da.la > 0 && g.pJ) g.Hb.style.cssText = g.Hb.style.cssText +
    ...
    function Gc(a) {
        ...
        this.S_ = this.th.transparentPng || q;
    ...
    x.extend(Gc.prototype, {
        ra: function(a, b) {
            ...
            delete this.Qb
        }, mt: u('S_'), getTilesUrl: function(a, b) {
    ...
    Qc.prototype.getTilesUrl = function(a, b) {
        var c = '';
        this.k.predictDate ?
            c = 'HistoryService?day=' + (this.k.predictDate.weekday - 1) + '&hour=' + this.k.predictDate.hour + '&t=' + (new Date).getTime() + '&' :
            (c = 'TrafficTileService?time=' + (new Date).getTime() + '&', c += 'label=web2D&v=016&');
        var c = this.xU + c + 'level=' + b + '&x=' + a.x + '&y=' + a.y, d = 1;
        this.C.Fx() && (d = 2);
    ...
    var Rc = [
        ...
        z.url.proto + z.url.domain.TILES_YUN_HOST[3] + '/georender/gss'], Sc = z.url.proto + z.url.domain.main_domain_nocdn.baidu + '/style/poi/rangestyle', Tc = 100;
    ...
    function mb(a, b) {
        ...
        c.pc = {
            ...
            B_: 'png',
            a3: [5, 5, 5, 5],
            wY: {backgroundColor: '#FFFFD5', borderColor: '#808080'},
            Sl: b.ak || qa,
            gu: b.tags || '',
            filter: b.filter || '',
            Gy: b.sortby || '',
    ...
    mb.prototype.getTilesUrl = function(a, b) {
        var c = a.x, d = a.y, e = this.pc,
            c = Rc[Math.abs(c + d) % Rc.length] + '/image?grids=' + c + '_' + d + '_' + b + '&q=' + e.Vm + '&tags=' + e.gu + '&filter=' + e.filter + '&sortby=' + e.Gy + '&ak=' +
                this.pc.Sl + '&age=' + e.tw + '&page_size=' + e.tN + '&format=' + e.B_;
    ...
    var Vc = [
        ...
        z.url.proto + z.url.domain.TILE_BASE_URLS[4] + '/it/'], Wc = [
        ...
        z.url.proto + z.url.domain.TILE_ONLINE_URLS[4] + '/tile/'], Xc = {dark: 'dl', light: 'll', normal: 'pl'}, Yc = new Gc;
    Yc.g_ = o;
    Yc.getTilesUrl = function(a, b, c) {
        var d = a.x, a = a.y, e = 1, c = Xc[c];
        this.map.Fx() && (e = 2);
        d = this.map.cb.yw(d, b).$r;
        return (Wc[Math.abs(d + a) % Wc.length] + '?qt=tile&x=' + (d + '').replace(/-/gi, 'M') + '&y=' + (a + '').replace(/-/gi, 'M') + '&z=' + b + '&styles=' + c + '&scaler=' +
        e + (6 == x.da.la ? '&color_dep=32&colors=50' : '') + '&udt=20170428').replace(/-(\d+)/gi, 'M$1')
    };
    ...
    var Pa = new Uc('\u4e09\u7ef4', Zc, {tips: '\u663e\u793a\u4e09\u7ef4\u5730\u56fe', minZoom: 15, maxZoom: 20, textColor: 'white', projection: new gb});
    Pa.Ac = function(a) {
        return Math.pow(2, 20 - a)
    };
    Pa.sk = function(a) {
    ...
    var Za = new Uc('\u536b\u661f', $c, {tips: '\u663e\u793a\u536b\u661f\u5f71\u50cf', minZoom: 1, maxZoom: 19, textColor: 'white'}), ad = new Gc({transparentPng: o});
    ad.getTilesUrl = function(a, b) {
        var c = a.x, d = a.y;
        return (Wc[Math.abs(c + d) % Wc.length] + '?qt=tile&x=' + (c + '').replace(/-/gi, 'M') + '&y=' + (d + '').replace(/-/gi, 'M') + '&z=' + b + '&styles=sl' +
        (6 == x.da.la ? '&color_dep=32&colors=50' : '') + '&udt=20161229').replace(/-(\d+)/gi, 'M$1')
    };
    ...
    var dd = 2, ed = 3, id = 0, jd = 'bt', kd = 'nav', ld = 'walk', md = 'bl', nd = 'bsl', od = 14, pd = 15, qd = 18, rd = 20, sd = 31;
        ...
        va: function() {
            ...
            if (!(1 > b)) {
                if (this.page >= this.Vf) {
                    var d;
                    a.push('<span style="margin-right:3px"><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp1}">\u9996\u9875</a></span>'.replace('{temp1}',
            ...
            for (e = d; e <= b; e++)0 < e && (e == this.page ?
                a.push('<span style="margin-right:3px">' + e + '</span>') :
                1 <= e && e <= this.Jd && (d = '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + e + ']</a></span>', a.push(
                    d.replace('{temp3}', 'BMap.I(\'' + this.ba + '\').toPage(' + e + ');'))));
            c > this.Jd || a.push('<span><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp4}">\u4e0b\u4e00\u9875</a></span>'.replace('{temp4}',
    ...
    x.extend(wd.prototype, {
        ...
        }, toString: ca('TransitRoute'), jU: function(a) {
            return a.replace(/\(.*\)/, '')
        }
    });
    var xd = wd.prototype;
    ...
    var Gd = Fd.prototype;
    S(Gd, {getPoint: Gd.sm, getLocation: Gd.Rs});
    ...
    x.extend(Kd.prototype, {
        Qi: s(), show: s(), U: s(), wF: function(a) {
            this.pc.types = a
        }, bn: function(a) {
            this.yd.src = a
        }, search: ba('aj'), wy: ba('WH')
    });
    var Ta;
    ...
    function Oa(a, b) {
        function c() {
            e.k.visible ?
                ('inter' === e.Ie && e.k.haveBreakId && e.k.indoorExitControl === o ? x.D.show(e.uA) : x.D.U(e.uA), this.k.closeControl && this.zf && this.C &&
                this.C.Na() === this.B ? x.D.show(e.zf) : x.D.U(e.zf), this.k.forceCloseControl && x.D.show(e.zf)) :
                (x.D.U(e.zf), x.D.U(e.uA))
        }
    ...
    x.extend(Oa.prototype, {
        QP: function() {
        ...
        }, jX: u('Xn'), Zb: u('Ya'), LX: u('Vv'), ZN: u('Vv'), ha: u('Lb'), Ea: u('Da'), fa: u('Jc'), gh: u('dl'), L2: function() {
            return this.c1 || []
            ...
            if (b) {
                var b = {panotype: this.Xs(), heading: this.Ea().heading, pitch: this.Ea().pitch, pid: b, panoid: b, from: 'api'}, c;
                for (c in b)a += c + '=' + b[c] + '&'
            }
            return a.slice(0, -1)
        }, Cx: function() {
    ...
    var Sd = Qd.prototype;
    S(Sd, {setPosition: Sd.ta, getPosition: Sd.ha, setContent: Sd.ad, getContent: Sd.tk, setAltitude: Sd.mF, getAltitude: Sd.Ro, getPov: Sd.Ea, show: Sd.show, hide: Sd.U});
    function Td(a, b) {
        Pd.call(this);
    ...
    x.extend(Td.prototype, {
        ta: function(a) {
            this.Lb = a;
            this.Lf('position', a)
        }, ha: u('Lb'), Bc: function(a) {
            this.nJ = a;
            this.Lf('title', a)
        }, bp: u('nJ'), Ub: function(a) {
            this.RH = icon;
            this.Lf('icon', a)
        }, Uo: u('RH'), mF: function(a) {
            this.pq = a;
            this.Lf('altitude', a)
        }, Ro: u('pq'), QD: u('pT'), Ea: function() {
            var a = p;
            if (this.P) {
    ...
    z.Rm(function(a) {
        'flashRender' !== a.Wq() && new bc(a, {Pf: 'api'})
    });
    x.extend(bc.prototype, {
        ca: function() {
            function a(a) {
    ...
    var Yd = bc.prototype;
    S(Yd, {getPanoramaById: Yd.Yo, getPanoramaByLocation: Yd.qj, getPanoramaByPOIId: Yd.ux});
    function ac(a) {
        Gc.call(this);
    ...
    x.extend(ae, {
        ip: function(a, b, c, d) {
            if (!b || !c || !c.lngLat || !c.panoInstance) d(); else {
                ...
                this.co.cC(b, function(b) {
                    b ? e.co.qj(c.lngLat, ae.nP, function(b) {
                        if (b && b.id) {
                            var f = b.id, k = b.uh, b = b.vh, l = bc.Ud.mh(c.lngLat), m = e.cS(l, {x: k, y: b}), k = e.vL(f, m, 0, ae.Au.width, ae.Au.height);
            ...
            e.push('<img class=\'pano_thumnail_img\' width=\'' + f + '\' height=\'' + g + '\' border=\'0\' alt=\'' + c + '\u5916\u666f\' title=\'' + c + '\u5916\u666f\' src=\'' + b +
            ...
            return (ae.Eu + '?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}').replace(/\{(.*?)\}/g,
                function(a, b) {
                    return f[b]
                })
        }
    ...
    var je = ee ? '-' + ee.toLowerCase() + '-' : '', le = ke('transform'), ne = ke('transitionProperty'), oe = ke('transitionDuration'), ue = ke('transformOrigin'),
        ve = ke('transitionTimingFunction'), we = ke('transitionDelay'), Dd = /android/gi.test(navigator.appVersion), xe = /iphone|ipad/gi.test(navigator.appVersion),
        ye = /hp-tablet/gi.test(navigator.appVersion), ze = ke('perspective') in de, Ae = 'ontouchstart' in window && !ye, Be = ee !== q, Ce = ke('transition') in de,
        De = 'onorientationchange' in window ? 'orientationchange' : 'resize', Ee = Ae ? 'touchstart' : 'mousedown', Fe = Ae ? 'touchmove' : 'mousemove',
        Ge = Ae ? 'touchend' : 'mouseup', He = Ae ? 'touchcancel' : 'mouseup',
        Ie = ee === q ? q : {'': 'transitionend', webkit: 'webkitTransitionEnd', Moz: 'transitionend', O: 'otransitionend', ms: 'MSTransitionEnd'}[ee],
        Je = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame ||
            window.msRequestAnimationFrame || function(a) {
                return setTimeout(a, 1)
            }, Ke = window.cancelRequestAnimationFrame || window.K4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame ||
            window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout, Le = ze ? ' translateZ(0)' : '';
    ...
    Me.prototype = {
        enabled: o, x: 0, y: 0, Aj: [], scale: 1, xC: 0, yC: 0, Se: [], uf: [], UB: p, Qy: 0, handleEvent: function(a) {
            switch (a.type) {
                case Ee:
            ...
            var b;
            this[a + 'Scrollbar'] ?
                (this[a + 'ScrollbarWrapper'] || (b = be.createElement('div'), this.options.jF ?
                    b.className = this.options.jF + a.toUpperCase() :
                    b.style.cssText = 'position:absolute;z-index:100;' + ('h' == a ?
                            'height:7px;bottom:1px;left:2px;right:' + (this.Ci ? '7' : '2') + 'px' :
                            'width:7px;bottom:' + (this.mi ? '7' : '2') + 'px;top:2px;right:1px'), b.style.cssText += ';pointer-events:none;' + je +
                    'transition-property:opacity;' + je + 'transition-duration:' + (this.options.EW ? '350ms' : '0') + ';overflow:hidden;opacity:' +
                    (this.options.Dx ? '0' : '1'), this.tn.appendChild(b), this[a + 'ScrollbarWrapper'] = b, b = be.createElement('div'), this.options.jF ||
                (b.style.cssText = 'position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);' + je + 'background-clip:padding-box;' + je +
                    'box-sizing:border-box;' + ('h' == a ? 'height:100%' : 'width:100%') + ';' + je +
                    'border-radius:3px;border-radius:3px'), b.style.cssText += ';pointer-events:none;' + je + 'transition-property:' + je + 'transform;' + je +
                    'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);' + je + 'transition-duration:0;' + je + 'transform: translate(0,0)' + Le, this.options.Bi &&
                (b.style.cssText += ';' + je + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)'), this[a + 'ScrollbarWrapper'].appendChild(b), this[a +
                'ScrollbarIndicator'] = b), 'h' == a ?
                    (this.LL = this.ML.clientWidth, this.TX = ce.max(ce.round(this.LL * this.LL / this.vy), 8), this.SX.style.width = this.TX + 'px') :
                    (this.KO = this.LO.clientHeight, this.$_ = ce.max(ce.round(this.KO * this.KO / this.Ep), 8), this.Z_.style.height = this.$_ + 'px'), this.oB(a, o)) :
                this[a + 'ScrollbarWrapper'] &&
                (Be && (this[a + 'ScrollbarIndicator'].style[le] = ''), this[a + 'ScrollbarWrapper'].parentNode.removeChild(this[a + 'ScrollbarWrapper']), this[a +
            ...
            this.Wk || (a = this.fp ? a : 0, b = this.nn ? b : 0, this.options.Tk ?
                this.Ob.style[le] = 'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Le :
                (a = ce.round(a), b = ce.round(b), this.Ob.style.left = a + 'px', this.Ob.style.top = b + 'px'), this.x = a, this.y = b, this.oB('h'), this.oB('v'))
        }, oB: function(a, b) {
            var c = 'h' == a ? this.x : this.y;
            this[a + 'Scrollbar'] && (c *= this[a + 'ScrollbarProp'], 0 > c ?
                (this.options.qD ||
                (c = this[a + 'ScrollbarIndicatorSize'] + ce.round(3 * c), 8 > c && (c = 8), this[a + 'ScrollbarIndicator'].style['h' == a ? 'width' : 'height'] = c +
                    'px'), c = 0) :
                c > this[a + 'ScrollbarMaxScroll'] && (this.options.qD ?
                    c = this[a + 'ScrollbarMaxScroll'] :
                    (c = this[a + 'ScrollbarIndicatorSize'] - ce.round(3 * (c - this[a + 'ScrollbarMaxScroll'])), 8 > c && (c = 8), this[a + 'ScrollbarIndicator'].style['h' == a ?
                        'width' :
                        'height'] = c + 'px', c = this[a + 'ScrollbarMaxScroll'] + (this[a + 'ScrollbarIndicatorSize'] - c))), this[a +
            'ScrollbarWrapper'].style[we] = '0', this[a + 'ScrollbarWrapper'].style.opacity = b && this.options.Dx ? '0' : '1', this[a +
            'ScrollbarIndicator'].style[le] = 'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + Le)
        }, CQ: function(a) {
            ...
            if ('select' != b && 'input' != b && 'textarea' != b)return a.stopImmediatePropagation ?
                a.stopImmediatePropagation() :
                a.kZ = o, a.stopPropagation(), a.preventDefault(), this.ax = this.MB = p, q
        }, Ov: function(a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (Ae && 1 < a.touches.length) &&
                (d = ce.abs(a.touches[0].pageX - a.touches[1].pageX), c = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.H_ = ce.sqrt(d * d + c * c), this.dy = ce.abs(
                        a.touches[0].pageX + a.touches[1].pageX - 2 * this.TF) / 2 - this.x, this.ey = ce.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.UF) / 2 -
                    this.y, this.options.up && this.options.up.call(this, a));
                if (this.options.Vx && (this.options.Tk ?
                        (c = getComputedStyle(this.Ob, p)[le].replace(/[^0-9\-.,]/g, '').split(','), d = +(c[12] || c[4]), c = +(c[13] || c[5])) :
                        (d = +getComputedStyle(this.Ob, p).left.replace(/[^0-9-]/g, ''), c = +getComputedStyle(this.Ob, p).top.replace(/[^0-9-]/g, '')), d != this.x ||
                    c != this.y)) this.options.Bi ? this.Wd(Ie) : Ke(this.UB), this.Aj = [], this.vr(d, c), this.options.ay && this.options.ay.call(this);
                this.hw = this.x;
                this.jw = this.y;
                this.du = this.x;
                this.eu = this.y;
            ...
            if (this.options.zoom && Ae && 1 < a.touches.length) e = ce.abs(a.touches[0].pageX - a.touches[1].pageX), f = ce.abs(
                a.touches[0].pageY - a.touches[1].pageY), this.G_ = ce.sqrt(e * e + f * f), this.Wk = o, b = 1 / this.H_ * this.G_ * this.scale, b < this.options.Vk ?
                b = 0.5 * this.options.Vk * Math.pow(2, b / this.options.Vk) :
                b > this.options.Vp && (b = 2 * this.options.Vp * Math.pow(0.5, this.options.Vp / b)), this.np = b / this.scale, e = this.dy - this.dy * this.np +
                this.x, f = this.ey - this.ey * this.np + this.y, this.Ob.style[le] = 'translate(' + e + 'px,' + f + 'px) scale(' + b + ')' + Le, this.options.lN &&
            this.options.lN.call(this, a); else {
                this.uh = b.pageX;
                this.vh = b.pageY;
                ...
                6 > this.fw && 6 > this.gw ||
                (this.options.CE && (this.fw > this.gw + 5 ? (f = this.y, d = 0) : this.gw > this.fw + 5 && (e = this.x, c = 0)), this.qh = o, this.vr(e, f), this.GC = 0 < c ?
                    -1 :
                    0 > c ?
                        1 :
                        0, this.HC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g - this.startTime && (this.startTime = g, this.du = this.x, this.eu = this.y), this.options.iN &&
                this.options.iN.call(this, a))
            }
        }, $u: function(a) {
            if (!(Ae && 0 !== a.touches.length)) {
                var b = this, c = Ae ? a.changedTouches[0] : a, d, e, f = {Ba: 0, time: 0}, g = {Ba: 0, time: 0}, i = (a.timeStamp || Date.now()) - b.startTime;
                d = b.x;
                e = b.y;
                b.Wd(Fe, window);
                b.Wd(Ge, window);
                ...
                if (b.Wk) d = b.scale * b.np, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Vp, d), b.np = d / b.scale, b.scale = d, b.x = b.dy - b.dy * b.np +
                    b.x, b.y = b.ey - b.ey * b.np + b.y, b.Ob.style[oe] = '200ms', b.Ob.style[le] = 'translate(' + b.x + 'px,' + b.y + 'px) scale(' + b.scale + ')' +
                    Le, b.Wk = q, b.refresh(), b.options.sp && b.options.sp.call(b, a); else {
                    if (b.qh) {
                        ...
                        f.Ba || g.Ba ?
                            (c = ce.max(ce.max(f.time, g.time), 10), b.options.au && (f = d - b.hw, g = e - b.jw, ce.abs(f) < b.options.Fy && ce.abs(g) < b.options.Fy ?
                                b.scrollTo(b.hw, b.jw, 200) :
                                (f = b.fJ(d, e), d = f.x, e = f.y, c = ce.max(f.time, c))), b.scrollTo(ce.round(d), ce.round(e), c)) :
                            b.options.au ?
                                (f = d - b.hw, g = e - b.jw, ce.abs(f) < b.options.Fy && ce.abs(g) < b.options.Fy ?
                                    b.scrollTo(b.hw, b.jw, 200) :
                                    (f = b.fJ(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) :
                                b.fo(200)
                    } else {
                        if (Ae)if (b.EK && b.options.zoom) clearTimeout(b.EK), b.EK = p, b.options.up && b.options.up.call(b, a), b.zoom(b.uh, b.vh,
                            1 == b.scale ? b.options.lW : 1), b.options.sp && setTimeout(function() {
                            ...
                            'select' != e && 'input' != e && 'textarea' != e ?
                                (e = be.createEvent('MouseEvents'), e.initMouseEvent('click', o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey,
                                    a.shiftKey, a.metaKey, 0, p), e.yR = o, d.dispatchEvent(e)) :
                                d.focus()
                        }
                        b.fo(400)
                    }
            ...
            if (b == this.x && c == this.y) {
                if (this.qh && (this.qh = q, this.options.ay && this.options.ay.call(this)), this.mi && this.options.Dx &&
                    ('webkit' == ee && (this.ML.style[we] = '300ms'), this.ML.style.opacity = '0'), this.Ci && this.options.Dx) 'webkit' == ee &&
                (this.LO.style[we] = '300ms'), this.LO.style.opacity = '0'
            } else this.scrollTo(b, c, a || 0)
        }, FU: function(a) {
            var b = this, c, d;
            if ('wheelDeltaX' in a) c = a.wheelDeltaX / 12, d = a.wheelDeltaY / 12; else if ('wheelDelta' in a) c = d = a.wheelDelta / 12; else if ('detail' in a) c = d = 3 *
                -a.detail; else return;
            if ('zoom' == b.options.TO) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Vk && (d = b.options.Vk), d > b.options.Vp && (d = b.options.Vp), d !=
                    b.scale) !b.Qy && b.options.up && b.options.up.call(b, a), b.Qy++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function() {
                    b.Qy--;
            ...
            a.Vl || (a.Aj.length ?
                (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Vl = o, a.qh = o, a.options.Bi) ?
                    (a.oJ(e.time), a.vr(e.x, e.y), a.Vl = q, e.time ? a.ca(Ie) : a.fo(0)) :
                    (g = function() {
                        var i = Date.now(), k;
                        if (i >= d + e.time) {
                            a.vr(e.x, e.y);
            ...
            a += 'ms';
            this.Ob.style[oe] = a;
            this.mi && (this.SX.style[oe] = a);
            this.Ci && (this.Z_.style[oe] = a)
            ...
            if ('string' == typeof this.options.au) {
                ...
                a = 0;
                for (b = c.length; a < b; a++)d = this.Zj(c[a]), d.left += this.TF, d.top += this.UF, this.Se[a] = d.left < this.fe ?
                    this.fe :
                    d.left * this.scale, this.uf[a] = d.top < this.nd ? this.nd : d.top * this.scale
            ...
            var e = c / this.scale;
            this.options.Tk && (this.Wk = o, d = d === j ? 200 : d, a = a - this.TF - this.x, b = b - this.UF - this.y, this.x = a - a * e + this.x, this.y = b - b * e +
                this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.fe ? this.fe : this.x, this.y = this.y > this.rf ?
                this.rf :
                this.y < this.nd ?
                    this.nd :
                    this.y, this.Ob.style[oe] = d + 'ms', this.Ob.style[le] = 'translate(' + this.x + 'px,' + this.y + 'px) scale(' + c + ')' + Le, this.Wk = q)
        }
    };
    function ke(a) {
        if ('' === ee)return a;
    ...
    x.extend(Ne.prototype, {
        Kk: function(a) {
            ...
            if (b || !this.$j[this.Xc] || !(this.$j[this.Xc].panoId == a && 3 !== this.$j[this.Xc].recoType)) {
                ...
                !b && -1 !== d && this.$j[d] && 3 !== this.$j[d].recoType ? this.Ip(d) : this.yX(function(a) {
                    for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length; m < n; m++)d = a[m].catlog, i = a[m].floor, j !== d &&
                    ('' === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Pe[d]] || (b[Pe[d]] = []), b[Pe[d]].push(a[m])));
            ...
            if (!this.Li) {
                ...
                new Me(a, {zo: q, Vx: o, mi: q, Ci: q, nn: q, CE: o, Cw: o, zx: o});
            ...
            if (this.Li) a = this.jL(this.Oi), this.qQ.innerHTML = a; else {
                var a = this.jL(this.Oi), b = M('ul'), c = this;
                ...
                x.M(b, 'click', function(a) {
                    if (a = (a.srcElement || a.target).getAttribute('dataindex')) {
                        c.Dl(c.TG[a]);
                        for (var d = b.getElementsByTagName('li'), e = 0, f = d.length; e < f; e++)d[e].childNodes[0].getAttribute('dataindex') === a ?
                            x.D.Ua(d[e], 'pano_catlogLiActive') :
                            x.D.Sb(d[e], 'pano_catlogLiActive')
                    }
                });
                ...
                x.M(d, 'mouseover', function() {
                    ...
                    new rb({
                        Gc: 60, jc: sb.Cs, duration: 300, va: function(c) {
                ...
                d = M('div');
                d.style.cssText = [
                    'position:absolute;z-index:2001;left:20px;', 'height:' + this.k.imageHeight + 'px;',
            ...
            this.$j = a;
            this.k.showCatalog && (0 < this.Oi.length ?
                (Va() ? this.PV() : this.SV(), this.Oc.offsetLeft = 60) :
                (this.Gs && (this.B.removeChild(this.Gs), this.Gs = p, this.Oc.gg.style.left = '0px'), this.Li &&
                (this.B.removeChild(this.Li), this.Li = p), this.Oc.offsetLeft = 0));
            var b = this.gX(a);
            Va() && (this.Oi && 0 < this.Oi.length && this.k.showExit && this.Xz) && (this.Oc.offsetLeft += this.fg.width + 8, this.Gs ? this.Gs.innerHTML = this.Xz : this.QV());
            this.Wh.innerHTML = b;
            this.Wh.style.width = (this.fg.width + 8) * a.length + 8 + 'px';
            a = this.B.offsetWidth;
            b = this.Wh.offsetWidth;
            this.Oc.Ns && (b += this.Oc.Ns());
            b < a - 2 * this.Oc.Fi - this.Oc.offsetLeft ?
                this.B.style.width = b + this.Oc.offsetLeft + 'px' :
                (this.B.style.width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth + 'px', b <
                this.B.offsetWidth - 2 * this.Oc.Fi - this.Oc.offsetLeft && (this.B.style.width = b + this.Oc.offsetLeft + 'px'));
            this.Oc.refresh();
            ...
            for (var b = '', c, d = 0, e = a.length; d < e; d++)c = '<div style="color:white;opacity:0.5;margin:0 35px;float:left;text-align: center"><span  dataIndex="' +
                a[d].index + '">' + a[d].data + '</span></div>', b += c;
            return b
        }, jL: function(a) {
            for (var b = '', c, d = 0, e = a.length; d < e; d++)c = '<li class="pano_catlogLi"><span style="display:block;width:100%;" dataIndex="' + a[d].index + '">' +
                a[d].data + '</span></li>', b += c;
            return b
        }, gX: function(a) {
            for (var b, c, d, e, f = [], g = this.fg.height, i = this.fg.width, k = 0; k <
            a.length; k++)b = a[k], recoType = b.recoType, d = b.panoId, e = b.name, c = b.heading, b = b.pitch, c = ae.vL(d, c, b, 198,
                108), b = '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k + '"><img style="width:' + (i - 2) + 'px;height:' + (g - 2) +
                'px;" data-index="' + k + '" name="' + e + '" src="' + c + '" alt="' + e + '"/><span class="pano_photo_decs" data-index="' + k + '" style="width:' + i +
                'px;font-size:' + Math.floor(g / 6) + 'px; line-height:' + Math.floor(g / 6) + 'px;"><em class="pano_poi_' + recoType + '"></em>' + e + '</span></a>', 3 ===
            recoType ?
                Va() ?
                    (this.Xz = b, this.AW = d, a.splice(k, 1), k--) :
                    (b = '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k + '"><img style="width:' + (i - 2) + 'px;height:' + (g - 2) +
                        'px;" data-index="' + k + '" name="' + e + '" src="' + c + '" alt="' + e +
                        ...
                        this.k.imageHeight + 'px;" data-index="' + k + '"><img src="' + E.qa + 'panorama/photoexit.png" style="border:none;vertical-align:middle;" data-index="' +
                        k + '" alt=""/></div></a>', f.push(b)) :
                f.push(b);
            return f.join('')
        }, yX: function(a) {
            ...
            this.Oc = F() ? new Me(this.fk, {zo: q, Vx: o, mi: q, Ci: q, nn: q, CE: o, Cw: o, zx: o}) : new Re(this.fk)
        }, U: function() {
    ...
    Re.prototype = {
        ra: function() {
            ...
            new rb({
                Gc: 60, jc: sb.Cs, duration: 300, va: function(d) {
    ...
    var Se = Uc.prototype;
    S(Se, {getTileLayer: Se.JX, getMinZoom: Se.Vo, getMaxZoom: Se.pm, getProjection: Se.$o, getTextColor: Se.vm, getTips: Se.Ys});
    S(window, {BMAP_NORMAL_MAP: Ma, BMAP_PERSPECTIVE_MAP: Pa, BMAP_SATELLITE_MAP: Za, BMAP_HYBRID_MAP: Sa});
    var Te = R.prototype;
    S(Te, {lngLatToPoint: Te.mh, pointToLngLat: Te.wi});
    var Ue = gb.prototype;
    S(Ue, {lngLatToPoint: Ue.mh, pointToLngLat: Ue.wi});
    var Ve = eb.prototype;
    S(Ve, {
        equals: Ve.nb,
        containsPoint: Ve.bs,
    ...
    var $e = pc.prototype;
    S($e, {setImageUrl: $e.PN, setSize: $e.ye, setAnchor: $e.qc, setImageOffset: $e.Pt, setImageSize: $e.SZ, setInfoWindowAnchor: $e.VZ, setPrintImageUrl: $e.e_});
    var af = sc.prototype;
    S(af, {
        redraw: af.ge,
        setTitle: af.Bc,
    ...
    var ff = Sb.prototype;
    S(ff, {setAnchor: ff.qc, getAnchor: ff.xD, setOffset: ff.Ve, getOffset: ff.Qf, show: ff.show, hide: ff.U, isVisible: ff.lh, toString: ff.toString});
    var gf = ib.prototype;
    S(gf, {getType: gf.dp, setType: gf.fn});
    ...
    var jf = jb.prototype;
    S(jf, {getUnit: jf.NX, setUnit: jf.xF});
    ...
    xd = wd.prototype;
    S(xd, {setPolicy: xd.Tt, toString: xd.toString, setPageCapacity: xd.Jp});
    ...
    S(window, {BMAP_POINT_SHAPE_STAR: 1, BMAP_POINT_SHAPE_WATERDROP: 2, BMAP_POINT_SHAPE_CIRCLE: vc, BMAP_POINT_SHAPE_SQUARE: 4, BMAP_POINT_SHAPE_RHOMBUS: 5});
    S(window, {
